package com.ej.rest.bestPractice.service.impl;
...
import com.ej.rest.bestPractice.exception.BizExceptionEnum;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public void updateEmployee(Employee employee) {
        ...
        if (employee.getId() == null)
            throw new BizException(BizExceptionEnum.ID_NULL_ERROR);
